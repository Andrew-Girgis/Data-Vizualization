...
\pandocbounded{\includegraphics[keepaspectratio]{STAT842_Assignment2_files/figure-latex/unnamed-chunk-2-1.pdf}}
...
\FunctionTok{ggplot}\NormalTok{(dat\_chess\_q2, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ remove\_value, }\AttributeTok{y =} \FunctionTok{reorder}\NormalTok{(target\_piece, remove\_value), }\AttributeTok{fill=} \FunctionTok{stat}\NormalTok{(x))) }\SpecialCharTok{+}
  \FunctionTok{coord\_cartesian}\NormalTok{(}\AttributeTok{clip =} \StringTok{"off"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_density\_ridges\_gradient}\NormalTok{(}\AttributeTok{scale =} \DecValTok{1}\NormalTok{, }\AttributeTok{alpha=}\FloatTok{0.5}\NormalTok{) }\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{STAT842_Assignment2_files/figure-latex/unnamed-chunk-4-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{STAT842_Assignment2_files/figure-latex/unnamed-chunk-5-1.pdf}}
...
\FunctionTok{require}\NormalTok{(magick)}
\FunctionTok{require}\NormalTok{(ggimage) }
\FunctionTok{require}\NormalTok{(ggplot2)}
=======
\end{Highlighting}
\end{Shaded}
>>>>>>> 484f834b10c1f62eef1d3615761109bcee1e3596
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Filter for target piece "N" (Knight)}
\NormalTok{dat\_chess\_q4 }\OtherTok{\textless{}{-}} \FunctionTok{subset}\NormalTok{(dat\_chess, target\_piece }\SpecialCharTok{==} \StringTok{"N"}\NormalTok{)}

\CommentTok{\# Summarize data}
\NormalTok{dat\_chess\_q4 }\OtherTok{\textless{}{-}} \FunctionTok{ddply}\NormalTok{(dat\_chess\_q4, }\StringTok{"loc\_removed"}\NormalTok{, summarize,}
...
\CommentTok{\# Convert file number to letter notation}
\NormalTok{dat\_chess\_q4}\SpecialCharTok{$}\NormalTok{filename }\OtherTok{\textless{}{-}}\NormalTok{ letters[dat\_chess\_q4}\SpecialCharTok{$}\NormalTok{file]}

\CommentTok{\# Define the image path}
\NormalTok{img\_path }\OtherTok{\textless{}{-}} \StringTok{"starting{-}positon{-}algebraic.jpg"}
...
\pandocbounded{\includegraphics[keepaspectratio]{STAT842_Assignment2_files/figure-latex/unnamed-chunk-6-1.pdf}}
...
<<<<<<< HEAD
\pandocbounded{\includegraphics[keepaspectratio]{Histogram_of_Piece_remove.png}}
=======
